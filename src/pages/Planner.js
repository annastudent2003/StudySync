...
const Planner = () => {
  ...
  useEffect(() => {
    ...
    if (stored[selectedDate]) {
      setFormData({
        mood: stored[selectedDate].mood || '',
        goals: stored[selectedDate].goals || '',
        priorities: stored[selectedDate].priorities || '',
        schedule: stored[selectedDate].schedule || '',
        notes: stored[selectedDate].notes || ''
      });
    }
  }, [selectedDate]);
